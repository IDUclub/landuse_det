...
async def calculate_area_indicator(
    ...
    territory_area = await IndicatorsService.calculate_territory_area(
...
async def services_count_indicator(
    ...
    services_count = await IndicatorsService.calculate_service_count(
...
async def calculate_project_area_indicator(
    ...
    project_area = await IndicatorsService.calculate_project_territory_area(
...
async def population_density_indicator(
    ...
    population_density = await IndicatorsService.population_density(
...
async def target_cities_indicator(
    ...
    target_cities_count = await IndicatorsService.target_cities(
        territory_id, force_recalculate=force_recalculate
    )
...
async def cities_indicator(
    ...
    big_cities_count = await IndicatorsService.city_size_indicator(
        territory_id, indicator_id, force_recalculate=force_recalculate
    )
...
async def engineering_infrastructure_indicator(
    ...
    engineering_infrastructure_count = (
        await IndicatorsService.engineering_infrastructure(
            territory_id, force_recalculate=force_recalculate
        )
    )
...
async def oop_indicator(
    ...
    oopt_parts_count = await IndicatorsService.oopt_parts(
        territory_id, force_recalculate=force_recalculate
    )
