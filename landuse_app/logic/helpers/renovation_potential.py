...
def calculate_profiled_building_area(
    buildings_in_zone: gpd.GeoDataFrame, zone: gpd.GeoSeries, profile_types: list
) -> float:
    """
...
async def get_renovation_potential(
    ...
    cache_file = caching_service.get_recent_cache_file(
...
async def filter_response(
    polygons_gdf: gpd.GeoDataFrame, filter_type: bool = False
) -> gpd.GeoDataFrame:
    """
